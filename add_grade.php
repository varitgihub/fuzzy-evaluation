...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Input validation
    if (is_numeric($student_id) && is_numeric($course_id) && is_numeric($grade) && $grade >= 0 && $grade <= 100) {
        ...
        $message = "Invalid input. Please ensure the IDs are numbers and the grade is between 0 and 100.";
    }
}
